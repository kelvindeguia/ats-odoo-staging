...
class WebsiteHrRecruitment(http.Controller):
    ...
    def jobs_detail(self, job, **kwargs):
        ...
        # Store the job ID and any relevant details in the session
        request.session['job_id'] = job.id
        request.session['job_name'] = job.name
        request.session['department_id'] = job.department_id.id
