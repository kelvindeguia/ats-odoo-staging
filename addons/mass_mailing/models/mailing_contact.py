...
class MassMailingContact(models.Model):
    ...
    # Custom Fields
    batch_number = fields.Char('Sending Batch Number', store=True)
    send_email_address = fields.Char('Sending Email Address', store=True)
    sent_email_1 = fields.Char('Send Email #1', store=True)
    sent_email_2 = fields.Char('Send Email #2', store=True)
    sent_email_3 = fields.Char('Send Email #3', store=True)
    sent_email_4 = fields.Char('Send Email #4', store=True)
    open_email_1 = fields.Char('Opened Email #1', store=True)
    open_email_2 = fields.Char('Opened Email #2', store=True)
    open_email_3 = fields.Char('Opened Email #3', store=True)
    open_email_4 = fields.Char('Opened Email #4', store=True)
